...
const TlBugPage = () => {
  ...
  useEffect(() => {
    const fetchBugs = async () => {
      try {
        setLoading(true);
        const response = await bugService.getTeamLeaderBugs(loggedInUserId);
        ...
        console.log("Team-leader Bug", normalizedBugs)
...
/* ================= HEADER ================= */
TlBugPage.header = () => (
  <HeaderContent title="TeamLeader Bugs" />
);

export default TlBugPage;
